<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MainForm.aspx.cs" Inherits="ProyectoWebCarDealer.MainForm" %>
...
<head runat="server">
    <title>CAR DEALER SAN FRANCISCO</title>
<meta charset="utf-8">
...
<div class="wrapper row0">
  <div id="topbar" class="hoc clear"> 
    ...
    <div class="fl_left">
      <ul>
        <li><i class="fa fa-phone"></i> +829-212-9281</li>
        <li><i class="fa fa-envelope-o"></i> cardelarsfm@gmail.com</li>
      </ul>
    </div>
    <div class="fl_right">
      <ul>
...
<div class="wrapper row1">
  <header id="header" class="hoc clear">
    <div id="logo"> 
      <!-- ################################################################################################ -->
      <h1><a href="MainForm.aspx">CAR DEALER SAN FRANCISCO</a></h1>
    ...
    <nav id="mainav" class="clear"> 
      <!-- ################################################################################################ -->
      <ul class="clear">
        <li class="active"><a href="MainForm.aspx">Home</a></li>
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="bgded overlay" style="background-image:url('images/demo/backgrounds/car.png');">
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="wrapper bgded" style="background-image:url('images/demo/backgrounds/car.png');">
  ...
  <main class="hoc container clear"> 
    ...
    <div class="group latest">
      ...
      <article class="one_third">
        ...
        <div class="txtwrap">
          <h4 class="heading">San Francisco De Macoris</h4>
          <ul class="nospace meta">
            <li>by <a href="#">Admin</a></li>
            <li>in <a href="#">Category Name</a></li>
          </ul>
...
<div class="wrapper row4">
  <footer id="footer" class="hoc clear"> 
    ...
    <div class="one_third first">
      <h6 class="heading">CAR DEALER SAN FRANCISCO</h6>
      <nav>
        <ul class="nospace">
          <li><a href="MainForm.aspx"><i class="fa fa-lg fa-home"></i></a></li>
